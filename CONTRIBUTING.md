...
programs/
  ...
  svs-7/          # Native SOL vault (ERC-7535 port, wSOL wrapping)
modules/
...
| **Native SOL**     | SVS-7 (Live)        | SVS-7 (Stored)        |
...
| Module | SVS-1 | SVS-2 | SVS-3 | SVS-4 | SVS-7 | Notes |
|--------|-------|-------|-------|-------|-------|-------|
...
| svs-rewards | scaffolding | - | - | - | scaffolding | Needs design for native SOL distribution |
| svs-oracle | scaffolding | - | - | - | - | SOL price needs no oracle (SOL is base asset) |
