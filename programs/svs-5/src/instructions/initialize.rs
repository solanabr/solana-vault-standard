//! Initialize instruction: create StreamVault PDA, shares mint, and asset vault.
...
use crate::{
    constants::{MAX_DECIMALS, SHARES_DECIMALS, SHARES_MINT_SEED, STREAM_VAULT_SEED},
    error::VaultError,
...
pub struct Initialize<'info> {
    ...
    #[account(
        ...
        seeds = [STREAM_VAULT_SEED, asset_mint.key().as_ref(), &vault_id.to_le_bytes()],
        bump
    )]
...
pub fn handler(
    ...
    msg!("StreamVault initialized: {} for asset {}", name, symbol);
