...
#[account]
pub struct NativeSolStreamVault {
    ...
    /// Native SOL uses 9 decimals, so offset exponent is 0.
    ...
    pub vault_id: u64,
    // Streaming fields
    /// Base assets (checkpoint baseline)
    pub base_assets: u64,
    /// Total shares (for share price calculation)
...
pub type Vault = NativeSolStreamVault;
