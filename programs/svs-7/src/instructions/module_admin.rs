//! Module administration instructions for SVS-7.
//!
...
use crate::state::{
    AccessConfig, CapConfig, FeeConfig, LockConfig, SolVault, ACCESS_CONFIG_SEED,
...
pub fn initialize_fee_config(
    ...
    fee_config.high_water_mark = svs_fees::HWM_SCALE;
