...
/// Withdraw exact lamports worth of native SOL, burning required shares.
///
/// Flow:
/// 1. Compute shares to burn (ceiling rounding — user burns more)
/// 2. Burn shares
/// 3. SPL Token transfer wSOL from vault → user temp wSOL ATA
/// 4. Close user's temp wSOL ATA → native SOL to user
