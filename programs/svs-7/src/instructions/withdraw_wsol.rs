//! Withdraw wSOL instruction: burn shares, transfer wSOL to user.
...
/// Withdraw exact wSOL amount, burning required shares.
/// Returns pre-wrapped wSOL (for protocol composability).
pub fn handler(ctx: Context<WithdrawWsol>, amount: u64, max_shares_in: u64) -> Result<()> {
