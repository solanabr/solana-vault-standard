...
pub fn convert_to_shares(
    ...
    .map_err(|e| match e {
        svs_math::MathError::Overflow => SolVaultError::MathOverflow.into(),
        svs_math::MathError::DivisionByZero => SolVaultError::DivisionByZero.into(),
    })
}
