/**
 * SVS-1 Full Drain Test
 *
 * Tests vault draining scenarios:
 * 1. Single user: deposit → redeem all → vault empty
 * 2. Multi-user: all users redeem → vault drained
 * 3. Re-deposit after drain works
 *
 * Run: npx ts-node scripts/svs-1/full-drain.ts
 */
...
async function main() {
  ...
  // ============================================================================
  // TEST 1: Single user full drain
  // ============================================================================
  console.log("\n" + "=".repeat(70));
  console.log("  TEST 1: Single User Full Drain");
  ...
  console.log(`  Assets recovered: ${assetsRecovered / 10 ** ASSET_DECIMALS} (deposited: ${depositAmount / 10 ** ASSET_DECIMALS})`);
  ...
  // ============================================================================
  // TEST 2: Multi-user full drain
  // ============================================================================
  console.log("\n" + "=".repeat(70));
  console.log("  TEST 2: Multi-User Full Drain");
  console.log("=".repeat(70));
  ...
  // Setup and deposit for each user
