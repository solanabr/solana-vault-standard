...
export function registerApproveDepositCommand(program: Command): void {
  program
    ...
    .action(async (vaultArg, opts) => {
      ...
      try {
        ...
        output.info(`Approving deposit for investor: ${investor.toBase58()}`);
        ...
        output.success(`Deposit approved for ${investor.toBase58()}`);
