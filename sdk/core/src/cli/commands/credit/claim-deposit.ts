...
export function registerClaimDepositCommand(program: Command): void {
  program
    .command("claim-deposit")
    .description("Claim shares from an approved deposit")
    ...
    .action(async (vaultArg, opts) => {
      ...
      try {
        ...
        output.info("Claiming deposit shares");
        ...
        output.success("Deposit shares claimed");
