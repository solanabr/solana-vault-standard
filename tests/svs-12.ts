...
describe("svs-12 (Tranched Vault)", () => {
  ...
  it("rejects unauthorized authority transfer", async () => {
    ...
    try {
      await program.methods
        ...
        .accountsStrict({ authority: fakeAuth.publicKey, vault })
        .signers([fakeAuth])
        .rpc();
      expect.fail("should have thrown");
    } catch (e: any) {
  ...
  describe("Insufficient Shares Redeem", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(v2Id, 0).accountsStrict({
      ...
      await program.methods.addTranche(0, 0, 500, 10000).accountsStrict({
      ...
      await program.methods.addTranche(1, 0, 0, 10000).accountsStrict({
      ...
      await program.methods.deposit(new BN(1000 * LAMPORTS), new BN(0)).accountsStrict({
    ...
    it("rejects redeem exceeding user share balance", async () => {
      ...
      try {
        await program.methods.redeem(excessiveShares, new BN(0)).accountsStrict({
          user: payer.publicKey, vault: v2Vault, targetTranche: v2JuniorTranche,
          tranche1: v2SeniorTranche, tranche2: null, tranche3: null,
          assetMint: v2Mint, userAssetAccount: v2UserAssetAta, assetVault: v2AssetVault,
          sharesMint: v2JuniorSharesMint, userSharesAccount: userSharesAta,
  ...
  describe("Deposit After Wipe", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(v3Id, 0).accountsStrict({
      ...
      await program.methods.recordLoss(vaultAccount.totalAssets).accountsStrict({
  ...
  describe("Subordination Breach on Redeem", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(v4Id, 0).accountsStrict({
        authority: payer.publicKey, vault: v4Vault, assetMint: v4Mint, assetVault: v4AssetVault,
        assetTokenProgram: TOKEN_PROGRAM_ID, associatedTokenProgram: ASSOCIATED_TOKEN_PROGRAM_ID,
        systemProgram: SystemProgram.programId,
      }).rpc();

      await program.methods.addTranche(0, 5000, 500, 10000).accountsStrict({
      ...
      await program.methods.deposit(new BN(500_000 * LAMPORTS), new BN(0)).accountsStrict({
    ...
    it("rejects junior redeem that would breach senior subordination", async () => {
      ...
      try {
        await program.methods.redeem(allShares, new BN(0)).accountsStrict({
          user: payer.publicKey, vault: v4Vault, targetTranche: v4JuniorTranche,
          tranche1: v4SeniorTranche, tranche2: null, tranche3: null,
          assetMint: v4Mint, userAssetAccount: v4UserAssetAta, assetVault: v4AssetVault,
          sharesMint: v4JuniorSharesMint, userSharesAccount: juniorSharesAta,
  ...
  describe("Cap Exceeded on Deposit", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(v5Id, 0).accountsStrict({
      ...
      await program.methods.addTranche(0, 0, 500, 1000).accountsStrict({
      ...
      await program.methods.deposit(new BN(1_000_000 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(100_000 * LAMPORTS), new BN(0)).accountsStrict({
  ...
  describe("Pro-Rata Yield Distribution", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(v6Id, 1).accountsStrict({
      ...
      await program.methods.deposit(new BN(600_000 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(400_000 * LAMPORTS), new BN(0)).accountsStrict({
    ...
    it("distributes yield proportionally to allocation shares", async () => {
      ...
      await program.methods.distributeYield(yieldAmount).accountsStrict({
  ...
  describe("Three-Tranche Lifecycle (Senior/Mezz/Junior)", () => {
    ...
    before(async () => {
      ...
      await program.methods.initialize(t3Id, 0).accountsStrict({
      ...
      await program.methods.addTranche(0, 3000, 300, 6000).accountsStrict({
        authority: payer.publicKey, vault: t3Vault, tranche: t3Senior, sharesMint: t3SeniorMint,
        token2022Program: TOKEN_2022_PROGRAM_ID, systemProgram: SystemProgram.programId, rent: SYSVAR_RENT_PUBKEY,
      }).rpc();

      // Mezz: priority=1, sub=10%, yield=6%, cap=8000
      await program.methods.addTranche(1, 1000, 600, 8000).accountsStrict({
      ...
      await program.methods.addTranche(2, 0, 0, 10000).accountsStrict({
      ...
      await program.methods.deposit(new BN(2000 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(3000 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(5000 * LAMPORTS), new BN(0)).accountsStrict({
    ...
    it("absorbs loss bottom-up across 3 tranches (spills to mezz)", async () => {
      ...
      await program.methods.recordLoss(lossAmount).accountsStrict({
    ...
    it("rebalances from mezz to junior to restore subordination after loss", async () => {
      ...
      await program.methods.rebalanceTranches(rebalanceAmount).accountsStrict({
        manager: payer.publicKey, vault: t3Vault,
  ...
  describe("Four-Tranche Lifecycle (Senior/SeniorMezz/JuniorMezz/Equity)", () => {
    ...
    before(async () => {
      ...
      // Initialize with sequential waterfall
      await program.methods.initialize(t4Id, 0).accountsStrict({
      ...
      await program.methods.addTranche(0, 4000, 200, 5000).accountsStrict({
      ...
      await program.methods.addTranche(1, 2000, 400, 7000).accountsStrict({
      ...
      await program.methods.addTranche(2, 1000, 800, 8000).accountsStrict({
      ...
      await program.methods.addTranche(3, 0, 0, 10000).accountsStrict({
      ...
      await program.methods.deposit(new BN(1500 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(2500 * LAMPORTS), new BN(0)).accountsStrict({
      ...
      await program.methods.deposit(new BN(4500 * LAMPORTS), new BN(0)).accountsStrict({
    ...
    it("rejects adding a 5th tranche (max 4)", async () => {
      ...
      try {
        await program.methods.addTranche(4, 0, 0, 10000).accountsStrict({
    ...
    it("redeems from senior in 4-tranche vault", async () => {
      ...
      await program.methods.redeem(redeemShares, new BN(0)).accountsStrict({
        user: payer.publicKey, vault: t4Vault, targetTranche: t4Senior,
        tranche1: t4SeniorMezz, tranche2: t4JuniorMezz, tranche3: t4Equity,
        assetMint: t4Mint, userAssetAccount: t4UserAssetAta, assetVault: t4AssetVault,
        sharesMint: t4SeniorMint, userSharesAccount: seniorSharesAta,
